...
### Запуск в продакшене с Docker

Проект включает настройку Docker для быстрого развертывания на сервере.
...
Приложение будет доступно на порту 80 вашего сервера.
...
#### Обновление проекта в продакшене
